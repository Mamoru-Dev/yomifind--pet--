  ...
  */
  class Cache {
    ...
    isGetInvariant(target, property) {
      ...
      return (
        descriptor !== undefined && descriptor.configurable !== true && descriptor.writable !== true
      );
    }
  ...
  class SmartClone {
    ...
    static isHandledType(value) {
      return isObject(value) || isArray(value) || isBuiltinWithMutableMethods(value);
    }
  ...
  const onChange = (object, onChange, options = {}) => {
    ...
    const handler = {
      ...
      apply(target, thisArg, argumentsList) {
        ...
        if (
          (details === false || (details !== true && !details.includes(target.name))) &&
          ...
          if (isChanged) {
            ...
            if (
              validate(path.get(object, changePath), property, thisProxyTarget, previous, applyData)
            ) {
